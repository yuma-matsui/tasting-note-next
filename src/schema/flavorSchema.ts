...
const flavorFirstImpressionsSchema = tuple(
  [enumType(FLAVOR_FIRST_IMPRESSIONS), enumType(FLAVOR_FIRST_IMPRESSIONS)],
  "2つ選択してください"
);

const flavorFlowersSchema = tuple([enumType(FLAVOR_FLOWERS), enumType(FLAVOR_FLOWERS)], "2つ選択してください");
...
const flavorImpressionsSchema = tuple(
  [enumType(FLAVOR_IMPRESSIONS), enumType(FLAVOR_IMPRESSIONS)],
  "2つ選択してください"
);
